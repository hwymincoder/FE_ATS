...
import { useDepartmentList } from '@/pages/departments/services/department-queries';
...
import DepartmentList from '@/pages/departments/components/DepartmentList';
```
...
|---|---|---|---|
| Server state (API data) | React Query | `pages/*/services/*.queries.js` | Danh sách phòng ban |
...
| Form state | React Hook Form + Zod | `pages/*/components/*.jsx` | Dữ liệu nhập form |
...
```js
// ✅ Tốt — Đặt trong pages/.../services/*.queries.js
...
Endpoint được define ở `pages/*/constants`. Không hardcode URL trong service hoặc component.
...
1. Tạo component trong `pages/<name>/components/`
